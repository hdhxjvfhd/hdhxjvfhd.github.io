window.addEventListener('scroll', () => {
  ...
  const images = ["images/teacher2.png", "images/teacher1.png", "images/teacher3.png", "images/teacher4.png",];
  const heading = ["Tomas Mosley", "Amanda Beck", "Juanita Nelson", "Dalton Myers"];
  const texts = [
